...
<?php 
    ...
    $query = "SELECT RollNumber, Name, PhoneNo, Email FROM details WHERE RollNumber = ?";
    $statement = $connection->prepare($query);
    if($statement) {
        $statement->bind_param("s", $rollInURL);
        if($statement->execute()) {
            $statement->bind_result($_POST['rollNumber'], $_POST['stdName'], $_POST['phone'], $_POST['email']);
